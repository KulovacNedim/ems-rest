...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlePasswordConfirmationException(
            PasswordConfirmationException ex, WebRequest request) {
    ...
    @ExceptionHandler(EmailCouldNotBeSentException.class)
    public ResponseEntity<Object> handleEmailCouldNotBeSentException(
            EmailCouldNotBeSentException ex, WebRequest request) {
        final String error = ex.getMessage();
